...
{
	dlib::ring_buffer<int> buffer(3, 7, 1);
	std::cout << " # create a ring-buffer => dlib::ring_buffer<int> buffer(3, 7, 1)" << '\n';
	log_buffer<int>(buffer);

	std::cout << "push back x 4" << '\n';
	buffer.push_back(4);
	buffer.push_back(5);
	buffer.push_back(6);
	buffer.push_back(7);
	...
	buffer.expand_capacity(14);
	log_buffer<int>(buffer);

	std::cout << "shrink capacity" << '\n';
	buffer.shrink_capacity(3);
	log_buffer<int>(buffer);
